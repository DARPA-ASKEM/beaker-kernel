...
def query_docs(query,collection_name="chiro_documentation_index",path="/home/jupyter/chromadb_functions",n_results=5): #to change dynamically on new context creation
